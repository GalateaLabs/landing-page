    ...
    <section id="benefits" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-bold text-foreground mb-4">¿Por qué elegir Aura?</h2>
          <p className="text-xl text-muted-foreground">Descubre cómo puede mejorar tu vida diaria</p>
        </div>
